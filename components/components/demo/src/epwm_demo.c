...
//-----------------------------------------------------------------------------------------------------------------------		
	...
	tPwmCfg.byWorkmod        = EPWM_SINGLE_UNI;         // SINGLE
	...
	if(tPwmCfg.byWorkmod==EPWM_SINGLE_SEP){
...
//------------------------------------------------------------------------------------------------------------------------	
	...
	tEpwmEmergencyCfg.EP0LKM  =  EPWM_LKMD_DIS;                //使能/禁止  EP0
    tEpwmEmergencyCfg.EP1LKM  =  EPWM_LKMD_DIS;
	tEpwmEmergencyCfg.EP2LKM  =  EPWM_LKMD_DIS;
    tEpwmEmergencyCfg.EP3LKM  =  EPWM_LKMD_DIS;//EPWM_LKM_SOFTLOCK;
	tEpwmEmergencyCfg.CMP0LKM =  EPWM_LKMD_DIS;
	tEpwmEmergencyCfg.CMP1LKM =  EPWM_LKMD_DIS;
	
    tEpwmEmergencyCfg.EP4LKM  =  EPWM_LKMD_DIS_1;//EPWM_LKM_SOFT_LOCK;  
	tEpwmEmergencyCfg.CMP2LKM =  EPWM_LKMD_DIS_1;
	tEpwmEmergencyCfg.CMP3LKM =  EPWM_LKMD_DIS_1;
	tEpwmEmergencyCfg.CMP4LKM =  EPWM_LKMD_DIS_1;
...
//------------------------------------------------------------------------------------------------------------------------111	
    csi_epwm_int_enable(EPWM, EPWM_INTSRC_PEND1,ENABLE);           //中断使能
//------------------------------------------------------------------------------------------------------------------------	
    csi_epwm_evtrg_enable(EPWM, EVTRG_PWM0_START, EPWM_TRG_ADC);//事件输出
//------------------------------------------------------------------------------------------------------------------------
    if(tPwmCfg.byWorkmod == EPWM_SINGLE_UNI	)csp_epwm_start(EPWM);//start  timer
	else{
